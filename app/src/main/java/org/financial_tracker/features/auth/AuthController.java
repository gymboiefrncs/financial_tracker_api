...
public class AuthController {
  ...
  @OpenApi(path = "/auth/login", methods = HttpMethod.POST, summary = "Login user", requestBody = @OpenApiRequestBody(content = @OpenApiContent(from = LoginRequest.class)), responses = {
